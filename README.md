...
<p align="left">👋 Je m'appelle Magomed Sataev, développeur spécialisé dans le back-end. Sur ce profil, vous trouverez mes projets et contributions mettant en avant mes compétences en PHP, Symfony, MySQL et DQL.

Passionné par le développement web, je m'efforce de concevoir des solutions performantes et adaptées aux besoins des utilisateurs. Mon objectif est d’évoluer constamment en explorant de nouvelles technologies et en travaillant sur des projets variés et ambitieux.

N'hésitez pas à explorer mes dépôts pour découvrir mon travail et ma progression. Je suis ouvert à toute collaboration ou discussion autour du développement web.</p>
